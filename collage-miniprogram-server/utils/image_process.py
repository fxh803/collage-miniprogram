...
# 贴上svg
def post_svgs(size_tensor,angle_tensor,pos_tensor,global_size,svg_num,original_svg_dir_list,svg_json_list,is_global_size,save_svg_path):
    shapes1 = []
    shape_groups1 = []
    count = 0
    ...
    pydiffvg.save_svg(f"{save_svg_path}/final.svg",
                            1000,
                            1000,
                            shapes1,
                            shape_groups1)
